...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2026 a las 17:15:36
...
INSERT INTO `empresa` (`IDEmp`, `RUT`, `Direccion`, `Mail`, `Nombre`, `Validacion`, `Activo`) VALUES
(5, '11111111111', 'Av Bulevar Artigas 1754', 'comidawow@gmail.com', 'Comida WOW', 1, 1),
(6, '22222222222', 'San Jose 1822', 'elpepecomida@gmail.com', 'El Pepe Comida', 0, 1),
(7, '33333333333', 'Camino Carrasco 5062', 'leappowersa@gmail.com', 'Lea Power Comida', 3, 1),
(42, '21070230019', 'republica', 'eloga@gmail.com', 'el oga srl', 1, 0);
...
INSERT INTO `local` (`ID`, `IDEmp`, `Foto`, `Direccion`, `Nombre`, `Delivery`, `Activo`) VALUES
(1, 5, 'https://lh3.googleusercontent.com/p/AF1QipPuEzx2guj16GDlfn8LRTVaa41rzDVon8tmeNQW=s680-w680-h510', 'Colonia 1399', 'Carrito Ale', 1, 1),
(2, 5, 'https://lh3.googleusercontent.com/p/AF1QipODIRVufmYeocCFwuVaIesJVicvMcWDOCfbqifa=s680-w680-h510', 'Rambla Presidente Charles de Gaulle', 'Hamburgueseria El Condor', 0, 1),
(3, 5, 'https://lh3.googleusercontent.com/p/AF1QipNzSGumcVfsNv9cPOFsFAzZptx3wATY1_UgbfKF=s680-w680-h510', 'Avenida Jose Belloni 4603', 'El Carro Naranja', 1, 1),
(4, 5, 'https://lh3.googleusercontent.com/p/AF1QipOTnOZQWr-RwHoAywp11pDSui5JZB5HbiAcuJ19=s680-w680-h510', 'Avenida Jose Belloni 4575', 'El Carrito de Jorge', 0, 1),
(5, 6, '', 'Camino Carrasco 6713', 'Carrito Delicias Caseras', 1, 1),
(6, 6, '', 'Rambla Edinson 2501', 'Carrito Puerto Madero', 0, 1),
(7, 6, 'https://lh3.googleusercontent.com/p/AF1QipOTkfM15SnovCyntN6E2dFC_CweTqJdQkiIB-DA=s680-w680-h510', 'Colonia 1152', 'Carrito El Italiano', 1, 1),
(8, 6, 'https://static.where-e.com/Uruguay/Montevideo_Department/Carrito-Los-Carlitos_68a4eb9d8c0a0edbb668eeaf99fbb8c5.jpg', 'Cuareim 1652', 'Carrito Los Carlitos', 0, 1),
(9, 7, 'https://lh3.googleusercontent.com/p/AF1QipMl-QThA1iMS9g_ZBS2yaJf2G1t2DvcEmh9TVKb=s680-w680-h510', 'Avenida Libertador 1436', 'El Macanudo', 1, 1),
(10, 7, 'https://lh3.googleusercontent.com/p/AF1QipNnDr2AWtkcj9TP7QeinA3ICVI09OMffujaonen=s680-w680-h510', 'General Pablo Galarza', 'Carrito Rosita', 0, 1),
(11, 7, 'https://lh3.googleusercontent.com/p/AF1QipNtevGGGRZEOY0FV3IPYaeYu9fdGm_gheJKTxRr=s680-w680-h510', 'Pablo de Maria', 'Carrito Lalo', 1, 1),
(12, 7, NULL, 'Estados unidos 1570', 'CarritoCerro S.A', 0, 1);
...
(12, '21070230019', '2025-12-23', 'Validada', 'el oga sa', 'republica', 'eloga@gmail.com', '0945642321'),
(13, '210703920014', '2025-12-25', 'Rechazada', 'elnes SA', 'Estados unidos 1570', 'Rodrigodelossantos3101@gmail.com', '093754113'),
(14, '2107039200143', '2026-01-23', 'Rechazada', 'CYBE S.A', 'Estados unidos 1570', 'Rodrigodelossantos313401@gmail.com', '093754113');
...
--
-- Volcado de datos para la tabla `solicitudlocal`
--

INSERT INTO `solicitudlocal` (`ID`, `IDEmp`, `Fecha`, `Estado`, `Nombre`, `Direccion`, `Delivery`, `Foto`, `ComentarioAdmin`, `IDLocCreado`) VALUES
(1, 7, '2026-02-19', 'Rechazada', 'CarritoCerro S.A', 'Estados unidos 1570', 0, NULL, 'Rechazado por administración.', NULL),
(2, 7, '2026-02-19', 'Validada', 'las algas', 'Republica Francesa 900', 0, NULL, NULL, NULL);
...
INSERT INTO `usuariosweb` (`ID`, `idRol`, `Direccion`, `Mail`, `Nombre`, `pass`, `DebeCambiarPass`, `Activo`) VALUES
(1, 3, '18 de Julio 3284', 'agustin@gmail.com', 'Agustin Acosta', '$2y$10$z7EmdsZnGl5FjUd0ikLGZuQiVZqRwZxpDfg2GgMmcgc9xhJodHiHy', 0, 1),
(2, 3, '8 de Octubre 2722', 'martin@gmail.com', 'Martin Martinez', '123', 0, 0),
(3, 3, 'Colonia 2523', 'santiago@gmail.com', 'Santiago De Leon', '123', 0, 0),
(4, 3, 'Durazno 1320', 'rodrigo@gmail.com', 'Rodrigo de Los Santos', '$2y$10$S8bJ6RBI9Wn46R5HlNqy/.u6Um2t4YWLD4xgBWUgTiGdK3Ql8Pzhy', 0, 1),
(5, 2, 'Av Bulevar Artigas 1754', 'comidawow@gmail.com', 'Comida WOW', '$2y$10$ocgiF44iwiwFD2bPXpH66umwR.ub57hhuAwhA9Tbmfbtbl0Umyf5O', 0, 1),
(6, 2, 'San Jose 1822', 'elpepecomida@gmail.com', 'El Pepe Comida', '$2y$10$iVetUt7Mteu3D1gVkwP2zOD4mYyrPyFu6vJPIEJRlELms8fQhYCM.', 0, 1),
(7, 2, 'Camino Carrasco 5062', 'leapowersa@gmail.com', 'Lea Power Comida', '$2y$10$1JCuUj5m1DCmfmjgqOJTT.LTWgu3OOLbsWUNsU5VchFntDrLbLjSW', 0, 1),
(29, 3, 'Republica francesa 900', 'ndelgado@cybe.com.uy', 'Nestor Delgado', '$2y$10$Q20BXsm6qq8.MX39PHA31uc263LQRppiXc09PFY.BN0plGyaK49zC', 0, 1),
(30, 3, 'Republica francesa 900', 'insumostadium@gmail.com', 'Lucas Paez', '$2y$10$PFlWyND1SKJ0jFhQ7giz4e/BHYqqa4AqIZNvIejjviOPleoWCZC52', 0, 1),
(31, 3, 'Estados unidos 1570', 'dlsfede4@gmail.com', 'Federico De los santos', '$2y$10$Ph/HFBE6vy2NUfveE4U7CuPmciQAoSG88sMKQFfNJ0jhmNMLXqXwO', 0, 1),
(32, 3, 'chacabuco 2024', 'chacabuco20241@gmail.com', 'Nestor Gabriel Delgado', '$2y$10$Aft9Smjtn1E/uwjU7qErT.a23tBuwc1yvhlLvG0B7a370XXWql/4W', 0, 1),
(33, 3, 'Suecia 2024', 'catenacciopia25@gmail.com', 'Maria Rodriguez', '$2y$10$pHk/oL2sIoEDpuZhKUuyZuJ1CtYdBS2k6pXTYnnSxEf45ctBFfoRC', 0, 1),
(34, 3, 'Estados unidos 1570', 'Rodrigodelossantos3101@gmail.com', 'Rodrigo de los santos', '$2y$10$hk/.h6eOo9stbPko9WZ4iuFc/GFV8LSd.0zAnrP1a1HGY4wScMylu', 0, 1),
(35, 3, 'Republica Francesa 900 esq Uruguayana', 'ngabrieel22@gmail.com', 'Gabriel Delgado', '$2y$10$ruLXUxRHK5B1uR6F.qvp4uUwyf9gLeyOd8OL.CdRprB7itLSTv4mC', 0, 1),
(36, 3, 'Av Libertador 1723 apto 701', 'Nazita06@gmail.com', 'Nazarena Rodriguez', '$2y$10$WHBqpY/6R1mLh19PB.p7o.oUR9a7dfIUFep5x4XpVQ9LMc0odDBS6', 1, 1),
(37, 3, 'Republica Francesa 900, CAPURRO', 'Lupaez2003@gmail.com', 'Insumos Stadium', '$2y$10$tEO6ERrm27LQAFTm2Oe.MOJsllb8mC6U4TlmJ5QYoMQRxmUmsOwum', 0, 1),
(38, 3, 'Andrés Lamas, 3634 ap 4', 'lugonand@outlook.es', 'Gonzalo Peña', '$2y$10$Oxmdh2C0N0XdSrdLj2OaPunlsXwk5klHmxQSgmSeC5PF9Y0kRtlqO', 0, 1),
(40, 3, 'Francisco Anzani 2140', 'hectorjosemz13@gmail.com', 'Hector Marante', '$2y$10$GQRS09Ud1PM5xRx5uw9Nhuz/bw8cq8T6S1n2NtuyE9hO.AeY9rFgK', 0, 1),
(41, 2, 'Estados unidos 1570', 'Rodrigodelossantos313401@gmail.com', 'CYBE S.A', '$2y$10$LS5AewfvwkENlTCg.rHDfuMBNXnZS8oRqiYTnzXwRVOQ53wfj9hL2', 0, 1),
(42, 2, 'republica', 'eloga@gmail.com', 'el oga sa', '$2y$10$9pvi2RLBPCHSH87Mz1s82ObD8HblPxFsnt6AGpH7xKot6BUqTjqhe', 1, 0);
...
(40, 12, 16, 70, 1, '2026-02-19', NULL),
(41, 12, 11, 70, 1, '2026-02-19', NULL);
